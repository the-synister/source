...
;General
  ...
  VIAddVersionKey "ProductName" "Synister"
  VIAddVersionKey "CompanyName" "QU Lab, TU Berlin"
  VIAddVersionKey "LegalCopyright" "(c) 2016 QU Lab, TU Berlin"
  VIAddVersionKey "FileDescription" "Synth Plugin Installer"
