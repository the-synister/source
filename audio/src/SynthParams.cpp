...
: serializeParams{ &freq,
    ...
    &lpCutoff, &biquadResonance, &lpModSource, &lpModAmount, &hpModSource, &hpModAmount, &keyVelocityLevel,
...
, biquadResonance("Filter Reso", "filterResonance", "Filter resonance", " ", 1.f, 10.f, 1.f)
