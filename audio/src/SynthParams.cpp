...
: serializeParams{ &freq,
    ...
    &lpCutoff, &biquadResonance, &ladderCutoff, &ladderRes, &lpModSource, &lpModAmount, &hpModSource, &hpModAmount,
...
, lpModAmount("LP ModAmnt", "lpModAmount", "prct", 0.f, 100.f, 0.f)
, hpModSource("HP ModSrc", "hpMod", eModSource::eNone, modsourcenames)
, hpModAmount("HP ModAmnt", "hpModAmount", "prct", 0.f, 100.f, 0.f)
