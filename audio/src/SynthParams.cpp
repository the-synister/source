...
SynthParams::Lfo::Lfo()
    ...
    // ModAmounts and Sources
    , freqModAmount1("LFO FreqModAmount1", "LFOFreqModAmount1", "LFO Freq ModAmount 1", "oct", 0.f, 4.f, 0.0f)
    , freqModAmount2("LFO FreqModAmount2", "LFOFreqModAmount2", "LFO Freq ModAmount 2", "oct", 0.f, 4.f, 0.0f)
    , freqModSrc1("LFO FreqModSrc1", "LFOFreqModSrc1", "LFO Freq ModSource 1", eModSource::eNone, modsourcenames)
    , freqModSrc2("LFO FreqModSrc2", "LFOFreqModSrc2", "LFO Freq ModSource 2", eModSource::eNone, modsourcenames)
    , gainModSrc("LFO GainModSrc", "LFOGainModSrc", "LFO Gain ModSource", eModSource::eNone, modsourcenames)
{
}
