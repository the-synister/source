...
, delayDividend("SyncDel Dividend", "", 1, 5, 1)
, delayDivisor("SyncDel Divisor", "", 1, 32, 4)
, delayCutoff("Cutoff", "Hz", 10.f, 20000.f, 20000.f)
, delayResonance("Resonance", "dB", -25.f, 0.f, 0.f)
, chorDelayLength("Chorus Width","s", .02f, .08f, .05f)
, chorModRate("Chorus Rate", "Hz", 0.f, 1.5f, 0.5f)
, chorDryWet("Chorus Dry/Wet", "%", 0.f, 1.f, 0.f)
, chorModDepth("Chorus Depth", "ms", 1.f, 20.f, 15.f)
, positionInfo()
, positionIndex(0)
{
