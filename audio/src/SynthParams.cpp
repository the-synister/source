...
, seqSpeed("SeqSpeed", "qn", 0.125f, 4.0f, 1.0f)
, seqNoteLength("SeqNoteLength", "qn", 0.125f, 4.0f, 1.0f)
, SeqNote1("seqNote1", "", -1, 127, 72)
, SeqNote2("seqNote2", "", -1, 127, 72)
, SeqNote3("seqNote3", "", -1, 127, 72)
, SeqNote4("seqNote4", "", -1, 127, 72)
