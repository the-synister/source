...
, osc1coarse("c.tune", "osc1coarse", "st", -36.f, 36.f, 0.f)
, osc1lfo1depth("mod", "osc1lfo1depth", "st", 0.f, 36.f, 0.f)
...
, keyVelocityLevel("Velocity Sense", "keyVelocityLevel", "dB", 0.f, 96.f, 25.0f)
